...
const ExploreSchemes = (props) => {
    return <section>
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            <div
                className="grid grid-cols-1 gap-y-8 lg:grid-cols-1 lg:items-center lg:gap-x-16"
            >
                <div
                    className="mx-auto max-w-7xl mb-12 lg:mx-0 lg:text-left text-left"
                >
                ...
                <div className="grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 gap-4 sm:grid-cols-2">
                    <a
                    ...
                    >
                        ...
                        <h2 className="mt-2 text-xl font-bold">Livelihood</h2>
                    ...
                    >
                        ...
                        <h2 className="mt-2 text-xl font-bold">Skills</h2>
                    ...
                    >
                        ...
                        <h2 className="mt-2 text-xl font-bold">Health</h2>
                    ...
                    >
                        ...
                        <h2 className="mt-2 text-xl font-bold">Women and Child</h2>
                    ...
                    >
                        ...
                        <h2 className="mt-2 text-xl font-bold">Scholarship</h2>
                    ...
                    >
                        ...
                        <h2 className="mt-2 text-xl font-bold">Miscellaneous</h2>
