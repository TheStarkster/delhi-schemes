        ...
        <div className="contrast-bg contrast-text banner relative bg-cover bg-center" style={{ backgroundImage: `url('/compensation.png')`, height: '300px' }}>
            ...
            <div className="contrast-bg contrast-text relative z-10 px-12">
                <div className="contrast-bg contrast-text mx-auto max-w-7xl text-left">
                    <h1 className="contrast-bg contrast-text text-2xl sm:text-2xl xl:text-4xl lg:text-4xl md:text-2xl font-bold text-white mb-4 pt-12">Support and Compensation Schemes in Delhi</h1>
                    <p className="contrast-bg contrast-text text-white">Discover Delhi's comprehensive compensation initiatives, including programs for child and adolescent labor, bonded labor rehabilitation, and victim assistance, ensuring justice and support for all</p>
                </div>
            </div>
        </div>
            ...
            <div className="contrast-bg contrast-text container mx-auto py-10">
